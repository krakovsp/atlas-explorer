...
const multiSelectStringFilter = function(headerValue, rowValue, rowData, filterParams) {
    // Если ничего не выбрано — показываем строку
    if (!headerValue || headerValue.length === 0) return true;
    
    // Если значение в ячейке отсутствует (null / undefined)
    if (rowValue === null || rowValue === undefined) return false;
    
    const currentVal = String(rowValue).trim();

    // Если headerValue - массив (мультиселект)
    if (Array.isArray(headerValue)) {
        return headerValue.map(v => String(v).trim()).includes(currentVal);
    }
    
    // Запасной вариант (если пришла одиночная строка)
    return String(headerValue).trim() === currentVal;
};
        ...
        headerTooltip: function() {
            return createHeaderTooltip("Official atlas title in English. If an English localization is missing, the original title is used. All initial articles have been removed for search convenience. Diacritical marks have also been removed (applies to all text fields in the table)")},
        },
            ...
            minWidth: 100,
            headerFilter: "list",
            headerFilterFunc: multiSelectStringFilter, 
            ...
            headerTooltip: function() {
            return createHeaderTooltip(
            "Date of the first launch of the EA using the same distribution method. The website address may have changed since then. This information was identified through the EA description, publications, Google Search, and the Wayback Machine",
             [
        ...
        return String(rowValue).toLowerCase().includes(String(headerValue).toLowerCase());
            ...
            minWidth: 100, 
            headerTooltip: function() {
            return createHeaderTooltip("Official name of the EA publisher. If published by a consortium, only the coordinating institution or the first few institutions are listed. Different entities are separated by “and”")},
            headerFilter: "list",
            /* Поиск подстроки, включая произвольный введённый текст */
            headerFilterFunc: "like",
            /* Не перерисовывать таблицу после каждой буквы */
            headerFilterLiveFilter: false,
            headerFilterParams: {
            valuesLookup: true,
            sort: "asc",
            /* Поиск внутри списка */
            autocomplete: true,
            /* Разрешает вводить значение, которого нет в списке */
            freetext: true,
            /* Показывает весь список до начала ввода */
            listOnEmpty: true,
            clearable: true,
            filterDelay: 250
    },
            headerFilterPlaceholder: "Enter keyword or select..."
            ...
            {title:"Type of App Developer", 
            field:"Type of App Developer",
            width: "11%", 
            minWidth: 100,  
            headerFilter: "list",
            headerFilterFunc: multiSelectStringFilter, 
            ...
            headerTooltip: function() {
                return createHeaderTooltip(
                "Developers of the application or cartographic component. If individual authors are listed but affiliated with a specific entity, that entity type is indicated. If the developer is not specified, the type of the publishing entity is provided instead. If there are multiple developers, the type is determined by the developer who contributed more to the application’s development",
                [
            ...
            headerFilterPlaceholder: "Enter keyword or select...",  
            headerTooltip: function() {
                return createHeaderTooltip("Developers of the application or cartographic component. If the developer is not specified, the publishing entity is provided instead. Different entities are separated by “and”")}
        },
        ...
        return String(rowValue).toLowerCase().includes(String(headerValue).toLowerCase());
            ...
            headerTooltip: function() {
                return createHeaderTooltip(
                "Number of atlas formats for which the atlas project provides development and maintenance",
                [
            ...
            headerTooltip: function() {
                ...
                { value: "Online", desc: "EA is available only via a web browser" },
                { value: "Hybrid (Native)", desc: "EA requires installation on the user’s computer or mobile device. However, part of its data is stored in the cloud and requires a continuous internet connection" },
                { value: "Hybrid (Sync)", desc: "EA requires installation on the user’s computer or mobile device. Requires a periodic internet connection only to download offline map packages and sync updates" },
                { value: "Hybrid (PWA)", desc: "EA is available online, but can be installed on the user's computer. Requires a continuous internet connection to load mapping data dynamically from the cloud. PWA leverages browser caching to store the interface shell locally, ensuring faster load times, reduced server requests, and basic functionality even during temporary connection losses" }
                ]);
            }
        },                        
            ...
            headerTooltip: function() {
                ...
                { value: "Atlas framework", desc: "Platform or framework specifically designed for the repeated creation of EAs. The platform/framework may be determined at your discretion if there are several identical atlas applications that differ only in terms of content" }
                ]);
            },
        },                          
        ...
        headerTooltip: function() {
            ...
            headerTooltip: function() {
                ...
                { value: "Educational", desc: "Atlases whose content has a didactic focus and is intended for students at a specific level of education" }
                ]);
            }
        },
            ...
            headerTooltip: function() {
                ...
                { value: "Complex", desc: "Comprehensive representation of a theme or territory according to the interpretation of Salichtchev (1976). The EA must include at least Nature, Environment, Society, and Economy. The level of detail is not considered" }
                ]);
            }
        },
            ...
            headerTooltip: function() {
                ...
                [{ value: "Economy and Trade", desc: "Economy, Trade, Finance, Agriculture, Industry, and Economic activity" },
                { value: "Environment", desc: "Ecology, Natural hazards, Human–environment interaction, and Environmental protection activities" },
                ...
                { value: "Nature", desc: "Geology, Geomorphology, Hydrology, Climatology, Glaciology, Oceanography, Soil geography, Flora and Fauna, etc. Nature is the primary focus; human–nature interaction is secondary, unlike in the Environment category" },
                { value: "Society", desc: "Administrative Divisions, Elections and Voting, Population, Migration, Settlements and Urbanism, Housing, Living conditions, Culture, Language, Religion, Education, etc." },
            ...
            headerFilterPlaceholder: "Enter keyword or select...",    
            headerTooltip: function() {
                return createHeaderTooltip("Specific theme of the EA. It is usually narrower than a topic and may relate to multiple topics simultaneously. For complex or polythematic EAs that characterise a territory across all major topics, the name of the territory should be specified")}
        },

            {title:"Ontology of Mapped Entities", 
            field:"Ontology of Mapped Entities",
            width: "11%", 
            minWidth: 100,   
            headerFilter: "list",
                headerFilterFunc: multiSelectStringFilter, 
                headerFilterPlaceholder: "Select multiple...",
                        headerFilterParams: { 
                            values: [
                                      "Earth Objects & Phenomena",
                                      "Space Objects & Phenomena",
                                      "Fictional World Objects & Phenomena",
                                      "Fictional Objects & Phenomena of the Real World",
                                      "Abstract Concepts"
                                  ],  
                            clearable: true,
                            multiselect: true
            ...
            headerTooltip: function() {
                ...
                { value: "Multiple regions", desc: "Covers more than one region and cannot be assigned to a single regional category" }
                ]);
            }
        },
            ...
            headerFilterPlaceholder: "Enter keyword or select...",   
            headerTooltip: function() {
                return createHeaderTooltip("Name of the specific geographic or administrative area covered by the atlas")}
        },
...

            {
...

             {
                ...
                headerTooltip: function() {
                return createHeaderTooltip("EA provides for regular content updates. Infrequent releases (less than once a year) do not count")}, 
                hozAlign:"center",
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                },

            {
                ...
                headerTooltip: function() {
                return createHeaderTooltip("Presence of a local data directory or data directory separated into a distinct section. The catalogue should be in the form of an attribute table or an interactive interface, and the data must be available for direct download from the EA")}, 
                hozAlign:"center",
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                },
        ...
        {title:"Metaconcept", 
                ...
                headerFilterPlaceholder: "Select multiple...",
                        headerFilterParams: { 
                            values: [
                                      ...
                                      "Collection of maps/modules",
                                      "Cartographic atlas application",
                                      "Visualization atlas",
                                      "Narrative atlas",
                                      "Encyclopedia",
            ...
            headerFilter: "list",
                ...
                headerFilterPlaceholder: "Select multiple...",
                        headerFilterParams: { 
                            values: [
                                      "Map-Vis Section",
                                      "Several Map-Vis Sections",
                                      "Non-Map Sections",
                                      "Non-Map Sections+One Map-Vis Section",
                                      "Non-Map Sections+Several Map-Vis Sections"
                                  ],  
                            clearable: true,
                            multiselect: true
                            },
            ...
            headerFilter: "list",
                ...
                headerFilterPlaceholder: "Select multiple...",
                        headerFilterParams: { 
                            values: [
                                      "General Public",
                                      "GIS-literate Amateurs",
                                      "Domain Specialists",
                                      "Domain Specialists with GIS Skills"
                                  ],  
                            clearable: true,
                            multiselect: true
                            },
...

            {
                ...
                headerTooltip: function() {
                return createHeaderTooltip("One or several standardized, repetitive (template-based) layouts are used for thematic content representation")}, 
                hozAlign:"center",
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                },
...

            {
                ...
                headerTooltip: function() {
            return createHeaderTooltip(
            "Number of pages containing unique thematic content. Navigational and landing or introductory pages are not included. Left blank for atlases with a large number of pages where counting would be too time-consuming",
              [
                "Use “-” to specify a range of values, e.g., 1–3" ,
                "Use the “>” operator for values strictly greater than, or “>=” for greater than or equal to, e.g., >=3",
                "Use the “<” operator for values strictly less than, or “<=” for less than or equal to, e.g., <=3",
        ...
        return String(rowValue).toLowerCase().includes(String(headerValue).toLowerCase());
                ...
                headerTooltip: function() {
                return createHeaderTooltip(
                "Depth of the information architecture of the thematic content (number of hierarchical levels). Counted from the homepage. The content hierarchy of map-vis sections with a single-page interface in multi-page atlases is counted as one level",
                ...
                headerFilterPlaceholder: "Select multiple...",
                        headerFilterParams: { 
                            values: [
                                      "One Classification",
                                      "One Classification+Filter",
                                      "Several Classifications",
                                      "Several Classifications+Filter"
                                  ],  
                            clearable: true,
                            multiselect: true
                            },
                ...
                headerFilter: "list",
                        headerFilterParams: { 
                           values: [
                                      "User-driven (Non-linear)",
                                      "Author-driven (Linear)",
                                      "Hybrid"
                                  ],  
                            clearable: true
                        },
                ...
                headerTooltip: function() {
                return createHeaderTooltip(
                "Detached navigation is independent of the primary navigation model and is typically located on a dedicated navigation page. It provides an overview of the EA structure and/or alternative access to its information units",
                [ { value: "None", desc: "" },
                { value: "Index", desc: "Alphabetical or geographical list of links to a defined set of information units (e.g., indicators, geographic features, authors, terms, keywords, or tags)" },
                { value: "Catalog", desc: "List of links in which information unit is characterized by several attributes and can be sorted and/or filtered by those attributes" },
                { value: "Sitemap", desc: "Provides an overview of and/or access to top-level EA nodes (typically within the first one to three hierarchy levels). It may be located in a navigation page, a modal window, a mega menu, or the footer" },
                { value: "Map", desc: "Map functions as the alternative gateway to the content" },
                { value: "TOC", desc: "Provides an overview of and/or access to top-level content sections of the EA (typically within the first one to three hierarchy levels). It may be located in a navigation page, a modal window, a mega menu, or the footer" },
                { value: "Graphic menu", desc: "Interactive overview interface where the EA content is represented as a graphical visualization (e.g., sunburst, circular treemap, etc.)" },
                { value: "Hybrid", desc: "Combination of several detached navigation models" }
                ]);
                }
        },
                ...
                headerTooltip: function() {
                return createHeaderTooltip(
                "Set of links and interface elements that provide access to information units (thematic content). Corresponds to global navigation",
...

            {
                ...
                headerTooltip: function() {
                return createHeaderTooltip("Raster static maps used for illustrative purposes are excluded from the image count. Interface icons, logos, background and other decorative interface images are not counted")}, 
                hozAlign:"center",
                formatter:"tickCross", 
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                ...
                headerTooltip: function() {
                return createHeaderTooltip("Embedded YouTube videos count. Tutorial videos and intro videos do not count")}, 
                hozAlign:"center",
                formatter:"tickCross", 
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                ...
                headerTooltip: function() {
                return createHeaderTooltip("Ordered sequence of frames that is automatically and sequentially played to create the perception of movement and/or change for the user. Camera movement animations (e.g. Fly-Through) are also counted. Decorative animation іs not taken into account")}, 
                hozAlign:"center",
                formatter:"tickCross", 
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                ...
                headerFilterPlaceholder: "Select multiple...",
                        headerFilterParams: { 
                           values: [
                                      ...
                                      "Separate Windows",
                                      "Internal & External",
                                      "Internal & Separate Windows",
                                      "External & Separate Windows",
                                      "Hybrid"
                                  ],
                            clearable: true,
                            multiselect: true
                ...
                headerTooltip: function() {
                return createHeaderTooltip("Ability for regular users to create an account. Subscribing to notifications alone is not considered. Registration must provide users with additional functionality")}, 
                hozAlign:"center",
                formatter: tabulatorTickCrossCleanFormatter,
                headerFilterPlaceholder: "Select value..."
                },
