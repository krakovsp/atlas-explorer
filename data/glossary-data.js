const GLOSSARY_DATA = [
    ...
    { 
        ...
        nested: [
            ...
            { term: "", category: "Educational", definition: "Atlases whose content has a didactic focus and is intended for students at a specific level of education" }
        ] 
    },
    ...
    { 
        number: "2.9",
        term: "Ontology of Mapped Entities",
    ...
    { 
        ...
        definition: "Number of pages containing unique thematic content. Navigational and landing or introductory pages are not included. Left blank for atlases with a large number of pages where counting would be too time-consuming"
    },
    { 
        number: "3.3.3",
    ...
    { 
        ...
        nested: [
            ...
            { term: "", category: "Graphic menu", definition: "Interactive overview interface where the EA content is represented as a graphical visualization (e.g., sunburst, circular treemap, etc.)" },
